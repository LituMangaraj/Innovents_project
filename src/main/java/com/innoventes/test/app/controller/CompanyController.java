...
import com.innoventes.test.app.dto.PartialCompanyDto;
...
@GetMapping("/byCode")
	public CompanyDTO getCompanyByCode(@RequestParam String companyCode){
		return companyService.getCompanyByCode(companyCode);
	}


	@PatchMapping("/update")
	public void updateCompany(@RequestBody PartialCompanyDto partialCompanyDto){
		companyService.updateCompany(partialCompanyDto);
	}
